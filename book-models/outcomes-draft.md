...
### Lesson 1.3-loops-and-models
  ...
  - **[DECLARED]** (know) After this section, the reader can recognize jugaad — the improvised, resourceful fix coding agents excel at — and see where disciplined engineering picks the good idea up and makes it durable. — _anchor: Heading text: 'Where jugaad ends' (Part I, adjacent to The Printer + vibe-coding; re-homed from 4.1 in round-8 W1 — W2 re-drafts the prose against the author's Part-I framing)._
...
### Lesson 3.2-models-and-the-semantic-gap
  ...
  - _elaborates (owned by the program):_ (create) After the book, the reader can model a system as structured, drift-checked views an agent reasons through, rather than leaving the structure in a human's head.
  - **[DERIVED]** (analyze) After this section, the reader can situate how far to model on a spectrum trading strength against changeability, and read the choice as an economic call whose sweet spot agents have moved outward. _(primary: execute-the-model-directly-a-spectrum-not-a-verdict · elaborated by: the-executable-zoo)_ — _anchor: point: executable-modeling-is-a-spectrum-agents-shift-the-optimum-outward_
...
### Lesson 3.3-the-governed-environment
...
### Lesson 3.6-when-guardrails-collide
