...
models, before turning to the profession itself: the education, the research, and the open problems
that a world of abundant implementation leaves unsettled. The question is no longer whether agents can
write code. The question is what engineers should do next.
