...
1. **Enforcement is what makes an obligation more than a request.** Guidance can influence a reasoner; enforcement determines what the engineered environment will permit or accept.
...
5. **Govern the governance machinery.** Constraints, sensors, validators, and gates form an engineering system of their own. Their coverage, correspondence, cost, effects, and failure modes must themselves be understood and controlled.
