...
1. **Authority binds consequences.** Guidance can influence a reasoner; an authoritative obligation is one the environment can act on.
2. **Place authority where the obligation becomes decidable.** Constraints act before work proceeds; sensors produce evidence; validators evaluate evidence; gates control admission. Prefer the earliest boundary where the environment has enough meaning and evidence to decide the obligation adequately.
