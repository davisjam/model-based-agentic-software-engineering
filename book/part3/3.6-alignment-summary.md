...
1. **Enforcement is what makes an obligation more than a request.** Guidance can influence a reasoner; an obligation is enforceable when the engineered environment can enforce it.
