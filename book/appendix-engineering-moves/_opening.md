...
<!-- figure: assets/moves-overview-cheatsheet.svg | *Ten recurring engineering problems and the moves that address them.* The moves apply the method developed in Chapters 2–4: model knowledge people repeatedly reconstruct, enforce decidable obligations, and make recurring judgment durable when doing so is worth the cost. -->
