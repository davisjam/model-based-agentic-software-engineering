...
Modeling gives consequential knowledge a durable representation that engineers and agents can inspect,
connect, and reason from. Some of that knowledge can also constrain what the engineering process accepts.
{{chapter:alignment}} discusses how Alignment gives those obligations authority.
