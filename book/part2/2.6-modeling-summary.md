...
Modeling gives engineering judgment a durable representation. It does not establish that a fabricator
understood that representation correctly, that the resulting artifact realizes it, or that the property
continues to hold as the system changes. Those are problems of Alignment, which {{chapter:alignment}}
takes up.
