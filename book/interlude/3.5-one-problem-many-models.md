...
The 250 MB requirement had therefore exposed a representation problem, not merely a large input.
...
<!-- figure: assets/interlude-graph-two-partitions.svg | *Two partitions of the same remediation graph.* The graph can be partitioned (a) spatially, by page or artifact location, or (b) causally, by topological frontier. Page partitioning groups work by where content occurs; frontier partitioning groups work by which computations are ready to execute. The remediation graph itself is unchanged. -->
