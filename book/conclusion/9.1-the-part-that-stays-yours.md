...
Software engineering is therefore one instance of a larger problem that commodity intelligence makes newly urgent. As agents become capable of performing consequential work across domains, the central question is not simply what they can do. It is what knowledge they should work through, what obligations should bind their actions and outputs, what evidence should be required before those outputs acquire consequence, and who remains responsible for the result.

MAGE's answer is to engineer those conditions rather than leave them entirely inside the agent.
