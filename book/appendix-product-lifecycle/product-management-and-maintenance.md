...
[ref:fig-h-ticket-bridge] Its particularly useful role is as a bridge model.
...
The ticket need not duplicate the models on either side. It binds one change episode to the relevant longer-lived representations.
...
[ref:fig-h-change-progression] The important progression runs from a local change to durable structure.
