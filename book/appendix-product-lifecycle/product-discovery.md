...
Product discovery operates where uncertainty is often desirable rather than defective. Customer needs clash. Proposed features embody hypotheses. Requirements are negotiated. Experiments are conducted precisely because important questions remain unsettled.

Product discovery therefore needs to preserve what the team knows and why it made particular choices. Useful models can include stakeholder needs, product hypotheses, experiment definitions and results, prototypes, decision records, provisional requirements, and relationships among them. Together, these representations capture the needs observed, hypotheses tested, evidence gathered, alternatives considered, and reasons behind product decisions. They model the product problem and the organization’s understanding of it, rather than primarily modeling the implementation.

Product discovery should therefore usually have a relatively light Alignment posture. Hypotheses, evidence, and provisional decisions can be worth preserving without becoming obligations that realization must satisfy. Provenance matters: where did a claim come from? Relationships matter: which evidence bears on which hypothesis? Promotion matters: which provisional decision has become accepted product intent? But much of the substantive judgment remains human because the purpose of discovery is partly to determine what the obligations should be. Rationales should be recorded, but elaborate models are likely unnecessary.

Agents can still provide substantial leverage. A reasoner can retrieve experiments relevant to a proposed capability, identify earlier product decisions it appears to contradict, trace stakeholder needs, compare competing evidence, or reconstruct why a previous direction was abandoned. External representation extends the reasoning horizon without pretending that the resulting judgment is mechanical.

Discovery also provides an important setting for the distinction among unknown, tacit, and free. A choice that appears unconstrained may reflect genuine product freedom. It may instead conceal an obligation not yet discovered or one that stakeholders have not articulated. Discovery is partly the work of finding out which is which.
