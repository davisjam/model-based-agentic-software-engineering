...
/* Part-opener THESIS box title-bar — a principlebox-marker box whose first line is a demoted "### TITLE"
...
def page(title: str, toc: str, main: str, mermaid: bool = False, provenance: str = "",
    ...
    # tracked markdown (the markdown source itself is the record — see book/BUILD.md), so this stays "" by
