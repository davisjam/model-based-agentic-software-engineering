...
**Engineering.** The discipline of exercising informed *control* over consequential systems and accepting *responsibility* for the resulting outcomes.

- ***Control.*** Sufficient command of a system to understand and direct it, evaluate its behavior and evidence, recognize its weaknesses and uncertainties, and change it when its assumptions no longer hold. Control does not require personally performing every act of realization: work can be delegated while control over the resulting system is retained.
- ***Responsibility.*** Answerability for consequential engineering decisions and their outcomes: deciding what should exist, what properties must hold, what evidence is sufficient, what authority may be delegated, which tradeoffs are acceptable, and whether the resulting system is fit to accept. Delegating work or limited authority does not delegate responsibility for the resulting engineering outcome. You make the call, and you take the fall.
...
<!-- figure: assets/gloss-gee.svg | The governed environment. Governance mechanisms enforce engineering obligations by acting directly on observable work or through explicit models that expose richer semantics. Durable models, mechanisms, procedures, and documentation accumulate as engineering capital. -->
