...
**Agentic engineering.** The deliberate engineering of the environments through which autonomous agents perform consequential work—the broader engineering problem of which this book's subject is one instance. It does not mean engineering performed by agents. Model-Based Agentic Engineering (MAGE) is the account developed here for addressing it; software engineering is this book's worked domain.
