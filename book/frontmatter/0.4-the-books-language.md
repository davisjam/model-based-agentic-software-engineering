...
**Software engineering.** The engineering discipline of controlled change in software systems: it creates and evolves software while preserving sufficient control over the properties and consequences that matter. The definition is shared with the companion *Software Engineering Handbook*, which develops it fully.[cite: davis2026sehandbook]

**Agentic engineering.** The deliberate engineering of the environments through which autonomous agents perform consequential engineering work—the broader engineering problem of which this book's subject is one instance. It does not mean engineering performed by agents. Model-Based Agentic Engineering (MAGE) is the account developed here for addressing it; software engineering is this book's worked domain.
