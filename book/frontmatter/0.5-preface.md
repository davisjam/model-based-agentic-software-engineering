...
Call the broader problem **agentic engineering**: the deliberate engineering of the environments through which autonomous agents perform consequential work. The term names the conditions engineered around agentic work, not engineering performed by agents. Model-Based Agentic Engineering (MAGE) is the account this book develops for addressing it: make consequential knowledge explicit in purposeful representations, give selected obligations evidence and enforcement outside the producing reasoner, and preserve useful judgment in durable structures that later work can inherit.
