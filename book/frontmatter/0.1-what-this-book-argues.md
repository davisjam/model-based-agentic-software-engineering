...
6. **Engineering work shifts toward higher levels of abstraction.** Engineers increasingly design the models, evidence, policies, and environments that let agents work safely. Implementation remains engineering work, but it is no longer the center of the engineer's role.
