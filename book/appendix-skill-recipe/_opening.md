...
The three mastery-skills introduced earlier in the book provide the worked examples. They model how the fleet communicates, how it applies the engineering method to its own work, and how it operates itself. Despite their different domains, all three were constructed in the same way: find the domain's fundamental model, layer independent facets onto it, and tie them together with a governing principle.
