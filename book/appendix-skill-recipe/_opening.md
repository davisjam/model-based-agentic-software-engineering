...
This appendix names that pattern as a three-step recipe and grounds each step in the three self-* skills you already met. [Chapter 1](appendix-e-theory.html) states the recipe; [Chapter 2](appendix-e-applying-the-recipe.html) applies it three times. Read the [Skills chapter](4.5-packaging-the-method-as-skills.html) for what those skills *do*; read on here for how they were *built*.
