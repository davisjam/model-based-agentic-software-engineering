...
The resulting model, control, or procedure can then become something future work must account for.
{{chapter:one-problem-many-models}} calls this practice ratcheteering: the particular structure can be corrected or replaced, but the consequential concern does not silently disappear.
