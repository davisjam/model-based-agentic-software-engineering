...
Across this chapter, implementation has moved without making engineering responsibility disappear. Autonomous systems can assume more realization, analysis, transformation, and routine validation. The engineer's work moves toward deciding what must be true, choosing representations that make consequential properties understandable, establishing what evidence is sufficient, allocating authority, making tradeoffs, and determining whether the resulting system is fit to accept.
