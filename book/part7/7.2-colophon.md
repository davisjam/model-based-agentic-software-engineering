...
Part V stated the counterfactual directly: a project at this scope and schedule became economically feasible because commodity intelligence made repeated software realization cheap enough for one engineer to explore a much larger design space. That changed the research method as well as the artifact. Competing architectures, governance mechanisms, modeling strategies, and workflows could be built, stressed, and discarded before the surviving patterns were compressed into theory.

**The theory did not precede the system. The system preceded the theory.**
