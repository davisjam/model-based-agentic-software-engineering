...
sustained high-volume periods, and briefly exceeded 3,000. Volume declined through the interval {{chapter:evidence}}
...
source for the support-ratio curve in {{chapter:evidence}}.
...
book. Generated bundles and vendored trees are included where they occur; {{chapter:evidence}}'s accounting note
...
These quantities establish orders of magnitude relevant to the {{chapter:evidence}} discussion. Their units, scopes,
...
The ledger's narrower purpose is traceability: the quantitative claims in {{chapter:evidence}} can be inspected
