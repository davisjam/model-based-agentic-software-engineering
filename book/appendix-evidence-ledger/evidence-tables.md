...
sustained high-volume periods, and briefly exceeded 3,000. Volume declined through the interval {{chapter:software-factories}}
...
source for the support-ratio curve in {{chapter:software-factories}}.
...
book. Generated bundles and vendored trees are included where they occur; {{chapter:software-factories}}'s accounting note
...
These quantities establish orders of magnitude relevant to the {{chapter:software-factories}} discussion. Their units, scopes,
...
The ledger's narrower purpose is traceability: the quantitative claims in {{chapter:software-factories}} can be inspected
