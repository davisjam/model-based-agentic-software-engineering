...
through recurrence. Chapter 5 preserves those differences rather than forcing every event through the
finished theory.
...
Chapter 5 uses two views of the evidence; [ref:two-views-of-the-evidence] sets them side by side.
...
Chapters 2–4 presented the compressed method. Here the direction reverses. §5.1–§5.4 return to the
originating case from which much of that terminology was induced, so the wrong turns matter. A finished
architecture shows what exists; a longitudinal case can show **why it exists and what it replaced**. §5.5
then asks whether independently built systems expose comparable structures. Depth supplies mechanism;
breadth supplies variation. Chapter 6 asks what general account can explain both.
