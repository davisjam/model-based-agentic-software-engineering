...
- **Model to answer a question.** Externalize the knowledge and intent needed for humans and agents to
  reason at the required scale. Stop when additional representation costs more to maintain than the reasoning
  it saves.
- **Enforce where the obligation becomes decidable.** Use the earliest boundary with sufficient
  semantics and evidence to decide the obligation. Local enforcement may act directly on actions or artifacts;
...
```
  ...
  ALIGN
  Enforce selected obligations where they become decidable.
  CONVERT
...
reasoning; Alignment enforces selected obligations, either through those models or directly over
