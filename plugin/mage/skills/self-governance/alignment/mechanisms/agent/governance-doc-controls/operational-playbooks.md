...
*Its place in the environment — the **canonical mechanism** for **GOVERN · Govern the control estate itself**. The variants and known uses that fold under it are gathered on the [construction-kit page](https://davisjam.github.io/model-based-agentic-software-engineering/constructing-the-gee.html#cap-govern).*
