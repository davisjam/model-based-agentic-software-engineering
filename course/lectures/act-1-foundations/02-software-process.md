  ...
  groups:
    ...
    - heading: Process models
      items:
        ...
        - 'Beck (1999), "Embracing Change with Extreme Programming." Describes the major practices of XP and its approach to embracing change compared with traditional Waterfall development.'
        - 'The Agile Manifesto and Principles. Beck, Fowler, Martin, et al., 2001.'
        - 'The Scrum Guide. Schwaber & Sutherland, November 2020.'
    - heading: A critical perspective
      items:
        - '"Extreme Programming Considered Harmful." Presents an engineering critique of Extreme Programming and reiterates the practices of XP.'
