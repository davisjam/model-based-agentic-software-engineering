...
readings:
  groups:
    ...
    - heading: Reasoning from architecture
      items:
        - 'Kruchten, ["The 4+1 View Model of Architecture."](https://doi.org/10.1109/52.469759) Kruchten argues that no single architectural representation is sufficient for all engineering concerns. Different views emphasize different properties of the same system, such as logical structure, processes and concurrency, development organization, and physical deployment, with scenarios tying the views together. Read the introduction, Figure 1, and the sections describing 2–3 of the views. Focus less on the specific 4+1 taxonomy than on the underlying idea: the useful representation depends on the engineering question being asked. Full citation: Philippe Kruchten, "The 4+1 View Model of Architecture," IEEE Software 12, no. 6 (1995): 42–50.'
