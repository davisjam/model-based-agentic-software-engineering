...
readings:
  groups:
    ...
    - heading: Modeling and representation
      items:
        - '[MAGE, Part II — Introduction.](https://davisjam.github.io/model-based-agentic-software-engineering/book/part-2-intro.html) Davis, 2026. Frames modeling: why large systems are understood through purposeful views, and why commodity intelligence changes the economics that once kept explicit models secondary in code-centric practice.'
