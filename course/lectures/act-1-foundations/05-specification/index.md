...
readings:
  groups:
    ...
    - heading: Specifications in practice
      items:
        - 'A substantial real software requirements specification (Alspaugh et al.). Skim rather than reading linearly: look at the different representational forms — natural language, tables, timing constraints, subsets, and descriptions of expected change — and ask why each form is used where it is. (Full title, Chicago citation, and link forthcoming.)'
