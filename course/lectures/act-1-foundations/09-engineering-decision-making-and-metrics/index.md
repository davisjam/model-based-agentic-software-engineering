...
Every unit of Act I has exercised this reasoning. Requirements asked what outcomes must hold in the world. Specification bounded what the machine and its environment must do. Architecture and Design compared alternatives by their consequences. Validation asked what evidence justifies a delivery. Each of those units also closes with a section headed *Measurement for decision-making*, asking what an engineer could observe to find out whether its model still holds. This lecture draws that shared structure together and makes it explicit: engineers identify consequential decisions, reason about the alternatives and their consequences, and determine what observations or measurements could provide evidence for those decisions. Measurement is therefore not a new topic arriving at the end of Act I. It is how engineering closes the loop between its models and the world.
