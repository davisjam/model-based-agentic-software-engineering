...
readings:
  groups:
    - heading: Decision-making theory
      items:
        - 'Salado, *Rethink Engineering* — selected chapters. The engineering-decision foundation for this unit: engineering is choosing among alternatives under uncertainty, not merely producing artifacts. Read it for the reframing and what the reframing obliges. If the engineering act is the decision, then an engineer owes an account of it: which alternatives were considered, what consequences distinguished them, what evidence was available when the choice had to be made, and what uncertainty was knowingly carried. Every unit of Act I has been asking a version of that question; this reading says why it is the same question each time. Full citation: Alejandro Salado, *Rethink Engineering* (selected chapters).'
        - 'Harris and Tayler, ["Don''t Let Metrics Undermine Your Business"](https://hbr.org/2019/09/dont-let-metrics-undermine-your-business) (2019). The measurement complement to Salado: **surrogation**, the danger that the representation used to inform a decision becomes confused with the property or objective it was meant to represent. Read it for the mechanism rather than the anecdotes. Surrogation is not cheating and does not require anyone to act in bad faith; it happens because the metric is visible and the property is not, so attention migrates to what can be seen. That is the precise failure this lecture guards against when it insists a measurement becomes evidence only through the property, metric, and conditions that give it meaning. Full citation: Michael Harris and Bill Tayler, "Don''t Let Metrics Undermine Your Business," *Harvard Business Review*, September–October 2019.'
    - heading: Decision-making in practice
      items:
        - 'Öqvist, Messinger, and Wohlrab, "Supporting Early Architectural Decision-Making through Tradeoff Analysis: A Study with Volvo Cars" (FSE Companion 2024). The whole chain running in industrial practice: architects model candidate architectures, acquire evidence through simulation, expose legitimate multi-property tradeoffs, and use visualization to find which consequential choices actually drive those tradeoffs. Read it as decision → model → evidence → judgment with real stakes attached, and note what the simulation is *for* — not to compute an answer, but to distinguish alternatives well enough that the remaining choice is a genuine engineering tradeoff rather than a guess. Full citation: Rebekka Öqvist, Michael Messinger, and Rebekka Wohlrab, "Supporting Early Architectural Decision-Making through Tradeoff Analysis: A Study with Volvo Cars," in *Companion Proceedings of the 32nd ACM International Conference on the Foundations of Software Engineering* (FSE Companion ''24), 2024.'
        - 'Forsgren et al., ["The SPACE of Developer Productivity: There''s More to It Than You Think"](https://queue.acm.org/detail.cfm?id=3454124) (2021). A consequential software-engineering property that resists single-number measurement. Read it for three moves this lecture generalizes: why an important property can be genuinely multidimensional, why individual activity counts are inadequate proxies for it, and how complementary measures can provide evidence about different dimensions rather than one measure standing in for the whole. Useful as the counterweight to Harris and Tayler: surrogation says what goes wrong when one observable substitutes for the property; SPACE shows what it takes to do better. Full citation: Nicole Forsgren, Margaret-Anne Storey, Chandra Maddila, Thomas Zimmermann, Brian Houck, and Jenna Butler, "The SPACE of Developer Productivity: There''s More to It Than You Think," *ACM Queue* 19, no. 1 (2021).'
