...
materials:
  - title: Syllabus slides (first-day framing)
    src: materials/0-1-Syllabus.pptx
---
...
- **Student consultation hours:** _To be announced._
...
- **_Model-Based Agentic Software Engineering_** — James C. Davis. 1st edition, 2026. [Read online](https://davisjam.github.io/model-based-agentic-software-engineering/book/mage-book.pdf)
- **_Software Engineering at Google: Lessons Learned from Programming Over Time_** — Titus Winters, Tom Manshreck, Hyrum Wright. O'Reilly Media, 1st edition, 2020. ISBN 9781492082798. [Read online](https://abseil.io/resources/swe-book/html/toc.html)

**Other readings** — some other texts from which readings may be assigned:

- **_Software Engineering_** — Sommerville, Pearson, 2016. The text has undergone major revisions over the years. We will refer to the 10th edition. The 9th edition has a similar table of contents and should be comparable. We would not recommend a version earlier than the 9th edition.
- **_The Mythical Man-Month: Essays on Software Engineering_** — Brooks. Reflections on his decades of engineering (IBM) and research (UNC) experiences. An e-edition is available through the library.
- **_Design Patterns_** — Gamma, Helm, Johnson, Vlissides. No need to read this one start-to-finish, but the Introduction and excerpts from the catalog will help shape your design thinking. An e-edition is available through the library.
- **_Code Complete 2_** — McConnell (especially if you have not taken ECE 30862 Object-Oriented Programming). Good advice from decades of software engineering experience at Microsoft.
...
_What are the fundamental activities and structures of software engineering?_
...
_How do we build out our designs and construct an environment in which humans and agents can review and change them safely?_
...
_How do software systems operate, survive, and change in real environments?_
...
_This syllabus is subject to change. You will be notified of any changes as far in advance as possible via an announcement on Brightspace. Monitor your Purdue email daily for updates._
