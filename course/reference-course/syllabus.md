...
See the [Calendar](calendar.md) for sequencing, [Lectures](../lectures/index.md) for instructional materials, the [Semester Project](../project/index.md) for project materials, and [Assessment](../assessment/project-assessment.md) for project and oral-exam guidance.
...
1. Choose and justify a software process for a given engineering context.
2. Develop and validate requirements and specifications.
3. Design and justify a software architecture.
4. Evaluate software using appropriate forms of evidence.
5. Defend engineering decisions made during a team software project.
